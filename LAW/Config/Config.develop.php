...
class XP_Config_Config
{
	...
	public static function getConfig()
	{
		...
		$dbConfig = array(
			'dsn'            => 'mysql:dbname=xplatform_qian;host=10.253.0.52;port=3307;charset=UTF-8',
			'username'       => 'dev',
			'password'       => 'ftXtKQuAIC',
		...
		return array(
			...
			'routeMapping'          => array(
				...
				'/distributor/modify/'                      => 'XP_Controller_Distributor/AddOrUpdate',
				'/distributor/ajaxUpdateOrSave'             => 'XP_Controller_DistributorAjax/UpdateOrSave',
				'/distributor/ajaxUpdateStatus'             => 'XP_Controller_DistributorAjax/UpdateStatus',
				'/distributor/ajaxGet$'                     => 'XP_Controller_DistributorAjax/get',
				'/distributor/ajaxGetOne$'                  => 'XP_Controller_DistributorAjax/getOne',
				'/distributor/test/'                        => 'XP_Controller_Distributor/Test',
				'/distributor/add/'                         => 'XP_Controller_Distributor/AddOrUpdate',
				'/distributor/checkEmail/'                  => 'XP_Controller_DistributorAjax/CheckEmail',
				'/distributor/checkName/'                   => 'XP_Controller_DistributorAjax/CheckName',
				'/distributor/del/'                         => 'XP_Controller_DistributorAjax/delete',
				...
				'/operator/modify/'                      => 'XP_Controller_Operator/AddOrUpdate',
				'/operator/ajaxUpdateOrSave'             => 'XP_Controller_OperatorAjax/UpdateOrSave',
				'/operator/ajaxUpdateStatus'             => 'XP_Controller_OperatorAjax/UpdateStatus',
				'/operator/ajaxGet$'                     => 'XP_Controller_OperatorAjax/get',
				'/operator/ajaxGetOne$'                  => 'XP_Controller_OperatorAjax/getOne',
				'/operator/test/'                        => 'XP_Controller_Operator/Test',
				'/operator/add/'                         => 'XP_Controller_Operator/AddOrUpdate',
				'/operator/checkEmail/'                  => 'XP_Controller_OperatorAjax/CheckEmail',
				'/operator/checkName/'                   => 'XP_Controller_OperatorAjax/CheckName',
				'/operator/del/'                         => 'XP_Controller_OperatorAjax/delete',
			...
			'callbackHandler'       => array( // 对应公众号的关键词
				'gh_593376886917' => array( // 飞拓-雪佛兰项目测试账户 我买票
					'积分查询'    => array('XP_Extension_FractaChevrolet_Handler', 'queryUserPoints'),
					'会员绑定'    => array('XP_Extension_FractaChevrolet_Handler', 'bindUser'),
					'事故协助处理'  => array('XP_Extension_FractaChevrolet_Handler', 'userBindStatus'),
					'租车服务预约'  => array('XP_Extension_FractaChevrolet_Handler', 'userBindStatus'),
					'代驾服务预约'  => array('XP_Extension_FractaChevrolet_Handler', 'userBindStatus'),
					'24h快速救援' => array('XP_Extension_FractaChevrolet_Handler', 'userBindStatus'),
				)
			),
			'callbackCommonHandler' => array( // 对应的公众号都需要调用的Handler，比如特定上报日志给商家等
				'gh_593376886917' => array('XP_Extension_FractaChevrolet_Handler', 'reportLog'),
			),
			'dbConfig'              => array(
				'reply'                 => array(
					'name'   => 'Reply',
			...
			'webservice'            => array(
                ...
                'hasWorkOrder'=>'http://test.mapi.gaopeng.com/wtg/has_feedback'
			),
			/*默认微信URL、Token配置，可以个性化*/
			'wxConfig'              => array(
				'url'   => 'http://xp.weituangou.mobi/weixin/callback',
